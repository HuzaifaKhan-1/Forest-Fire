...
- Total COâ‚‚ Emissions: ${document.getElementById('total-co2-emissions').textContent} tonnes
...
// Live SMS Dispatch for Hackathon Demo
async function dispatchDemoSMS() {
    ...
    try {
        ...
        if (response.ok && data.success) {
            showToast('ðŸš¨ Alert Sent successfully!', 'success', 3000);
...
async function updateDashboardExplainability() {
    ...
    try {
        // Collect current live values from UI
